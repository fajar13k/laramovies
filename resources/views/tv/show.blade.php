            ...
            <div class="container mx-auto lg:px-32 rounded-lg overflow-y-auto">
              <div class="bg-gray-900 rounded">
                ...
                <div class="modal-body px-8 py-8">
                  ...
                  >
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/{{ $tvshow['videos']['results'][0]['key'] }}" frameborder="0" class="responsive-iframe absolute top-0 left-0 w-full h-full" style="border: 0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                  </div>
                </div>
              </div>
            </div>
